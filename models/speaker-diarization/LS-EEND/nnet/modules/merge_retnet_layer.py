...
class TransformerEncoderFusionLayer(Module):
    ...
    @property
    def self_attn(self):
        # PyTorch 2.x's TransformerEncoder expects custom layers to expose a
        # `self_attn` attribute for shape/fast-path checks.
        return self.self_attn2
    ...
    def forward(self, src: Tensor, src_mask: Optional[Tensor] = None,
        ...
        Args:
            ...
            is_causal: Unused compatibility argument accepted by PyTorch 2.x's
                TransformerEncoder wrapper.
